...
class testPokTests: XCTestCase {
    ...
    func testDealForTwoPlayersAndEvaluate() {
        ...
        dealer.dealHoldemCardsTo(&p1, cards: ["A♠", "K♠"])
        dealer.dealHoldemCardsTo(&p2, cards: ["2♥", "2♦"])
        dealer.table.dealtCards = [Card(suit: "♠", rank: "Q"), Card(suit: "♠", rank: "J"), Card(suit: "♠", rank: "T"), Card(suit: "♠", rank: "2"), Card(suit: "♠", rank: "3")]
        dealer.evaluateHoldemHandAtRiverFor(&p1)
        dealer.evaluateHoldemHandAtRiverFor(&p2)
    ...
    func testDealForTwoPlayersAndEvaluateSplit() {
        ...
        var p2 = Player(name: "Jane")
        dealer.dealHoldemCardsTo(&p1, cards: ["A♠", "K♠"])
        dealer.dealHoldemCardsTo(&p2, cards: ["A♥", "K♦"])
        dealer.table.dealtCards = [Card(suit: "♠", rank: "Q"), Card(suit: "♦", rank: "J"), Card(suit: "♦", rank: "T"), Card(suit: "♥", rank: "2"), Card(suit: "♠", rank: "3")]
        dealer.evaluateHoldemHandAtRiverFor(&p1)
        dealer.evaluateHoldemHandAtRiverFor(&p2)
        dealer.updateHeadsUpWinner(player1: p1, player2: p2)
    ...
    func testPlayerCardHistory() {
        var dealer = Dealer(evaluator: eval)
        var p1 = Player(name: "Jim")
        dealer.dealHoldemCardsTo(&p1, cards: [Card(suit: "♠", rank: "A"), Card(suit: "♠", rank: "K")])
        dealer.dealHoldemCardsTo(&p1, cards: [Card(suit: "♠", rank: "Q"), Card(suit: "♠", rank: "J")])
        dealer.dealHoldemCardsTo(&p1, cards: [Card(suit: "♠", rank: "T"), Card(suit: "♠", rank: "9")])
        XCTAssertTrue(p1.historyOfDealtHoldemCards[0].0 == Card(suit: "♠", rank: "A"))
        XCTAssertTrue(p1.historyOfDealtHoldemCards[0].1 == Card(suit: "♠", rank: "K"))
        XCTAssertTrue(p1.historyOfDealtHoldemCards[1].0 == Card(suit: "♠", rank: "Q"))
